...
parser.add_argument("--max_choices", type=int, default=20, help="number of training steps (0 to disable)")
...
parser.add_argument("--ngfI", type=int, default=32, help="number of generator filters in first conv layer")
parser.add_argument("--max_length", type=int, default=32, help="max number of words in the caption")
parser.add_argument("--ndfI", type=int, default=32, help="number of discriminator filters in first conv layer")
